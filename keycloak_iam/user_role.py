...
from keycloak_iam.role import admin_role, airflow_admin_role, airflow_trusted_viewer_role, airflow_viewer_role, trusted_guest_role
...
assign_roles_to_exiting_users(
    ...
    role_ids=[trusted_guest_role.id, airflow_trusted_viewer_role.id, airflow_viewer_role.id],
